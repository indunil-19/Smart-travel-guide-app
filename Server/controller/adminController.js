...
class AdminController {
  ...
  static async addImgtoProvinceData(req, res) {
    const provinceList = {
      p1: "Northern Province",
      p2: "North Western Province",
      p3: "Western Province",
      p4: "North Central Province",
      p5: "Central Province",
      p6: "Sabaragamuwa Province",
      p7: "Eastern Province",
      p8: "Uva Province",
      p9: "Southern Province",
    };
  ...
  static async getSharedPlans(req, res) {
    Travelplan.find({
      ownedBy: "617acefbaa2522ab237609ed",
      rate: req.body.rate,
      public: false,
    })
  ...
  static async setPublicPlan(req, res) {
    Travelplan.findOneAndUpdate(
      { _id: req.body.planId, ownedBy: "617acefbaa2522ab237609ed" },
      { public: true },
      { new: true }
    )
      .then((data) => {
