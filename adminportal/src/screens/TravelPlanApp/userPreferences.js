  ...
  return (
    <>
      ...
      >
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogBody>{aleartBody}</AlertDialogBody>
      ...
      <Box alignItems="center" padding="50">
        ...
        >
          <Heading>
            1.Select at most 3 Provinces you like to visit in Sri Lanka?
          </Heading>
          <Link to="/travelPlan/provinces">
            <Text color="blue" textDecoration="underline">
              refer informations about provinces
            </Text>
          </Link>
          <Box pt={10} pb={10}>
            <CheckboxGroup
              colorScheme="green"
              onChange={(e) => setProvinces(e)}
            >
        ...
        >
          <Heading>
            2.Climate Condition would you expect while travelling?
          </Heading>
          <Box pt={10} pb={10}>
        ...
        >
          <Heading>
            4.Any religion you would like to see in your travel?
          </Heading>
          <Box pt={10} pb={10}>
            <Select variant="filled" p={10}>
        ...
        >
          <Heading>
            5.Select at most 3 places you like to visit in Sri Lanka?
          </Heading>
          <Box pt={10} pb={10}>
            <CheckboxGroup
              colorScheme="green"
              onChange={(e) => setPlacesLike(e)}
            >
              <VStack alignItems="start">
