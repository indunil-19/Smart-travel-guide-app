...
describe('home page test', () => {
    ...
    it("shoud render plan card correctly",async()=>{
        const div = document.createElement("div");
        render(<MemoryRouter><TravelProvider><Home /></TravelProvider></MemoryRouter>,div)

        waitFor(()=>{
            const planCard= screen.getByTestId("tplan")
    ...
    it("should match snapshot",  () => {
        const tree = renderer.create(<MemoryRouter><TravelProvider><Home/></TravelProvider></MemoryRouter>);
